  ...
  return (
    <nav className="border-b border-[#2A2A2A] bg-[#0A0A0A] sticky top-0 z-50">
      <div className="container mx-auto flex items-center h-14 px-4">
        ...
        {/* CENTER: Theory + The Wall — always visible */}
        <div className="hidden md:flex items-center gap-6 absolute left-1/2 -translate-x-1/2">
          <Link
            to="/theory"
            className="text-sm text-[#555] hover:text-[#F5F0E8] transition-colors"
          >
            The Theory
          </Link>
          <Link
        ...
        <div className="flex items-center gap-3 shrink-0 ml-auto">
          {user ? (
            <>
              ...
              <Link
                to="/notifications"
                className="relative p-1.5 hover:bg-[#1A1A1A] transition-colors"
              >
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 top-10 w-44 bg-[#141414]
                                  border border-[#2A2A2A] z-50 py-1">
                    <button
                      onClick={() => {
                      ...
                      className="w-full flex items-center gap-2 px-4 py-2 text-sm
                                 text-[#F5F0E8] hover:bg-[#1E1E1E] transition-colors text-left"
                    >
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-2 px-4 py-2 text-sm
                                 text-[#8B3A3A] hover:bg-[#1E1E1E] transition-colors text-left"
                    >
                      <LogOut size={14} />
                      Log out
                    </button>
